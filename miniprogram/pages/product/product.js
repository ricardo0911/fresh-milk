...
Page({
    ...
    loadProduct(id) {
        // 模拟数据
        const mockProducts = {
            1: { id: 1, name: '每日鲜牛奶', specification: '250ml×10瓶', price: '39.90', original_price: '49.90', cover_image: 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400&q=80', is_hot: true },
            2: { id: 2, name: '有机纯牛奶', specification: '1L×6盒', price: '89.00', original_price: '108.00', cover_image: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=400&q=80', is_hot: true, is_new: true }
        };
